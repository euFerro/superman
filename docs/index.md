...
features:
  ...
  - title: 🤖 Auto-generated OpenAPI
    details: Instantly exposes a /spec route with a valid OpenAPI 3.1 document. No more manual drift between code and documentation.
  ...
  - title: ⚡ Universal Power
    details: Runs natively on Node.js, Bun, and Deno with zero native dependencies, delivering immense speed wherever you deploy.
